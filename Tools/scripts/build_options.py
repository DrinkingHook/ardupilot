...
BUILD_OPTIONS = [
    ...
    Feature('CAN', 'KST CAN', 'HAL_KST_CAN_ENABLE', 'Enable KST CAN support', 0, 'DroneCAN'),
    ...
    Feature('Actuators', 'PrerotaingCan', 'AP_PrerotaingCan_ENABLED', 'PreRotating CAN Driver', 0, None),
